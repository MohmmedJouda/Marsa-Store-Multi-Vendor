        ...
        <nav class="nav">
            <ul class="nav-list">
                <li class="logoheader"><a href="{{ route('customer.main-page')}}"><img
                            src="{{asset('assets2/images/logo/logo.svg')}}" class="apple-logo" /></a></li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">تفاصيل المتجر</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
    ...
    <div class="seller-profile dark-box ">
            ...
            <div class="profile-left">
                ...
                <div class="profile-info">
                    ...
                    <div class="rating">
                        ...
                        <p>متوسط التقييم: {{ number_format($store->storeRating()->avg('rate') ?? 0, 1) }} / 5</p>
        ...
        <div class="seller-comments dark-box">
            ...
            <ul class="comments-list" id="comments-list">
                @foreach($store->comments as $comment)
                    <li>
                        ...
                        @if($comment->rating) {{-- تحقق من وجود تقييم --}}
            ...
            <div class="comment-box">
                <form action="{{ route('customer.stores.comments.store', $store->id) }}" method="POST">
                    @csrf
            ...
            <div class="seller-products-slider">
                <h3 style="color: azure;">منتجات المتجر</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-12">
                                <div class="footer-logo" style="margin-top: 10px;">
                                    <a href="{{ route('customer.main-page')}}">
