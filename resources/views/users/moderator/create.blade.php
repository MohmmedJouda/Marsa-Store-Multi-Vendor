...
<form method="POST" action="/moderator/vendor" id="kt_modal_add_customer_form"
class="form">
@csrf
<!--begin::Modal header-->
...
<div class="modal-body py-10 px-lg-17">
    ...
    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
        ...
        <div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
            ...
            aria-expanded="false" aria-controls="kt_customer_view_details">Store
            Information
