...
@section('content')
    ...
    <form method="POST" action="/moderator/vendor" id="kt_modal_add_customer_form" class="form">
        @csrf
        <!--begin::Modal header-->
        ...
        <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                ...
                <div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                    ...
                    aria-controls="kt_customer_view_details">Store
                    Information
                ...
                <div id="kt_modal_add_customer_billing_info" class="collapse show">
                    ...
                    <div class="row g-9 mb-7">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" placeholder="+9705******" name="state" />
                            <!--end::Input-->
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select name="country" data-control="select2" data-placeholder="Select a Country..."
                            data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
