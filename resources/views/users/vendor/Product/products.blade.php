    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl ">
            {{-- <div style="margin-bottom: 40px; margin-top: -40px">
                <h1 class="text-gray-800">Products
                    @if (request()->has('id'))
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            @foreach ($products as $product)
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                                                ...
                                                                <span class="symbol-label" style="background-image:url({{ $product->images()->where('is_main', true)->first()
                                ? asset('storage/' . optional($product->images()->where('is_main', true)->first())->image_path)
                                : asset('images/placeholder.png') }});">
                                                            ...
                                                            <div class="ms-5">
                                                                <!--begin::Title-->
                                                                <a href="{{ route('vendor.product.show', $product->slug) }}"
                                                    ...
                                                    <td class="text-end pe-0">
                                                        <span class="fw-bolder">{{ $product->subcategory->name }}</span>
                                                    </td>
                                                    <!--end::SKU=-->
                                                    <!--begin::Qty=-->
                                                    <td class="text-end pe-0" data-order="25">
                                                        <span class="fw-bolder ms-3">{{ $product->stock }}</span>
                                                    </td>
                                                    <!--end::Qty=-->
                                                    <!--begin::Price=-->
                                                    <td class="text-end pe-0">
                                                    ...
                                                    <td class="text-end pe-0" data-order="Published">
                                                        ...
                                                        <div
                                                            class="badge
                                                                                                                                                                                                                        @if ($product->status == 'active') badge-light-success
                                                                                                                                                                                                                        @elseif($product->status == 'inactive') badge-light-danger @endif ">
                                                            {{ $product->status }}
                                                        </div>
                                                        <!--end::Badges-->
                                                    </td>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                            ...
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a onclick="confirmDestroy({{ $product->id }},this)" class="menu-link px-3">
                                                                    <span class="me-2">
