...
<head>
    ...
    <style>
        :root {
            --kt-font-family-sans-serif: "Cairo", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji";
        }
...
<body id="kt_body"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('vendor.products.index')}}">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('vendor.products.create')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('vendor.categories.index')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            @elseif(Auth::user()->role === 'super_admin')
                                                    <a class="menu-link" href="{{ route('admin.users.byRole', 'vendor') }}">
                                                @endif
                                                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                                        ...
                                        <div class="menu-item">
                                            ...
                                            @elseif(Auth::user()->role === 'super_admin')
                                                    <a class="menu-link" href="{{ route('admin.users.byRole', 'customer') }}">
                                                @endif
                                                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                            ...
                            @if (Auth::user()->role == 'vendor')
                                <div class="menu-item">
                                    <a href="{{ route('vendor.orders') }}" class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                        ...
                                        <span class="menu-title">طلبات الزبائن</span>
                                    </a>
                                </div>
                            ...
                            @if (Auth::user()->role == 'moderator')
                                <div class="menu-item">
                                    <a href="{{ route('moderator.orders') }}" class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-6">
                                                <a href="../../demo1/dist/apps/projects/users.html"
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <span class="fs-5 fw-bold text-gray-800 mb-0">الزبائن</span>
                                ...
                                <div class="d-flex align-items-center me-1 ms-lg-3 w-100"
    ...
    : asset('img/default-avatar.png') }}" alt="user" />
                                    </div>
    ...
    : asset('img/default-avatar.png') }}" />
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                                        {{Auth::user()->name}}
                                                        <span
                                                            class="badge badge-light-success fw-bolder fs-8 px-2 py-1 me-2">
                                                            @if (Auth::user()->role === 'vendor')
                                                                تاجر
                                                            @elseif (Auth::user()->role === 'moderator')
                                                                مدير
                                                    ...
                                                    @if (Auth::user()->role === 'vendor')
                                                        <p style="font-size:12px" class="mt-2"> <span
                                                                style="font-weight: bold">اسم
                                                                المتجر:</span>
                                        ...
                                        <div class="menu-item px-5">
                                            <a href=" {{ route('profile.show') }}" class="menu-link px-5"> الملف
                                                الشخصي</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                            ...
                                            <div class="mb-3 mb-md-0 fw-bold">
                                                ...
                                                <div class="fs-6 text-gray-700 pe-7">تسجيل الدخول into Admin لوحة التحكم
                                                    to
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{asset('ssets/media/avatars/300-5.jpg')}}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="me-5">
